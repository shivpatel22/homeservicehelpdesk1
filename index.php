...
$cities = ["Ahmedabad", "Anand","Amreli", "Khambhat", "Surat", "Surendranagar", "Vadodara", "Junagadh", "Jamnagar", "Bhavnagar", "Bharuch","Kutch","Bhuj","Dwarka"];

?>

<h2 class="text-center" style="margin-top: 20px">Home Service Helpdesk</h2>
<hr>
<div class="container" style="margin-top:20px; margin-bottom: 60px;">
    ...
    <div class="row">
        <div class="form-group col-5">
            ...
            <select class="form-control" name="city" id="city">
                <option value="none">Select the city</option>
        ...
        <div class="form-group col-5">
            ...
            <select class="form-control" name="profession" id="profession">
                ...
                <option value="mobile">Renovation</option>
                <option value="mobile">Color</option>
                <option value="mobile">Furniture</option>
                <option value="mobile">cable operator</option>
                <option value="mobile">wi-fi repairing</option>
            </select>
        </div>
    ...
    <div class="table-responsive">
        <table id="providers" class="table">
            ...
            <tbody>
                <tr>
                    <td colspan='5'>Select city and Which Service you needed..</td>
                </tr>
            </tbody>
        </table>
    </div>
            ...
            if (city == "none" || profession == "none") {
                ...
                $.post('scripts/searchproviders.php', {
                    ...
                    if (providers.failed == true) {
                        tbody = "<tr><td colspan='5'>No Service Providers found in your city...</td></tr>";
                    } else {
